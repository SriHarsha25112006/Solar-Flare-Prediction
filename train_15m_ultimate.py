"""
SolarForge Ultimate — 15-Minute Hybrid Model Training Pipeline
=============================================================
Combines deep-tree classifiers for C and M classes with a scale-invariant, 
shallow-tree classifier for the rare X-class.
"""
import pandas as pd
import numpy as np
import warnings
...
def main():
    print("============================================================")
    print("    SolarForge — 15-MINUTE ULTIMATE HYBRID ENGINE         ")
    print("============================================================\n")
    ...
    print(f"\n{'='*65}")
    print(f"  FINAL 15-MINUTE ULTIMATE PREDICTION SCORES (TSS)")
    print(f"{'='*65}")
    ...
    joblib.dump(model_data, 'rf_model_15-Min_Ultimate.pkl')
    joblib.dump(model_data, 'ensemble_model.pkl')
    print("\n[*] Model Pipelines Saved to: rf_model_15-Min_Ultimate.pkl & ensemble_model.pkl")
