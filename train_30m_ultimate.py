"""
SolarForge Ultimate — 30-Minute Hybrid Model Training Pipeline
=============================================================
Combines deep-tree classifiers for C and M classes with a scale-invariant, 
shallow-tree classifier for the rare X-class, targeting a 30-minute horizon.
"""
import pandas as pd
import numpy as np
import warnings
...
def main():
    print("============================================================")
    print("    SolarForge — 30-MINUTE ULTIMATE HYBRID ENGINE         ")
    print("============================================================\n")
    ...
    # Shift for 30-minute prediction (180 rows at 10-sec cadence)
    horizon_rows = 180
    ...
    smote_X = SMOTE(sampling_strategy={1: 20000}, random_state=42)
    ...
    print(f"\n{'='*65}")
    print(f"  FINAL 30-MINUTE ULTIMATE PREDICTION SCORES (TSS)")
    print(f"{'='*65}")
    ...
    joblib.dump(model_data, 'rf_model_30-Min_Ultimate.pkl')
    print("\n[*] 30-Min Model Pipeline Saved to: rf_model_30-Min_Ultimate.pkl")
