"""
SolarForge Ultimate — 4-Hour Hybrid Model Training Pipeline
============================================================
Combines deep-tree classifiers for C and M classes with a scale-invariant, 
shallow-tree classifier for the rare X-class, targeting a 4-hour horizon.
"""
import pandas as pd
import numpy as np
import warnings
...
def main():
    print("============================================================")
    print("    SolarForge — 4-HOUR ULTIMATE HYBRID ENGINE            ")
    print("============================================================\n")
    ...
    # Shift for 4-hour prediction (1440 rows at 10-sec cadence)
    horizon_rows = 1440
    ...
    print(f"\n{'='*65}")
    print(f"  FINAL 4-HOUR ULTIMATE PREDICTION SCORES (TSS)")
    print(f"{'='*65}")
    ...
    joblib.dump(model_data, 'rf_model_4-Hour_Ultimate.pkl')
    print("\n[*] 4-Hour Model Pipeline Saved to: rf_model_4-Hour_Ultimate.pkl")
